...
@section('content')
     <div class="container h-100">
          ...
          <div class="d-flex mb-3">
               ...
               <a href="#" class="ma-4 link-dark text-decoration-none" data-bs-toggle="modal" data-bs-target="#addTagModal">
                    <div class="d-flex align-items-center">
                              ...
                              <div class="cart mx-2 mb-2">
                                   <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                             ...
                                             <div class="dropdown">
                                                  <a href="#" class="dropdown-toggle px-1 fs-5 fw-bold link-dark text-decoration-none menu-icon" id="dropdownTodoMenuLink" role="button" data-bs-toggle="dropdown" aria-expaned="false">︙</a>
                                                       ...
                                                       <li>
                                                            <form action="{{ route('goals.todos.update', [$goal, $todo]) }}" method="post">
                                                                 ...
                                                                 @if ($todo->done)
                                                                      ...
                                                                      <button type="submit" class="dropdwon-item btn btn-link">未完了</button>
                                                                 @else
                                                                      <input type="hidden" name="done" value="true">
                                                                      <button type="submit" class="dropdown-itme btn btn-link">完了</button>
                                                                 @endif
                                                            </form>
                                                       </li>
                                                       <li><a href="#" class="dropdonw-item" data-bs-toggle="modal" data-bs-target="#editTodoModal{{ $todo->id }}">編集</a></li>
                                                       <div class="dropdown-divider"></div>
                                                       <li><a href="#" class="dropdonw-item" data-bs-toggle="modal" data-bs-target="#deleteTodoModal{{ $todo->id }}">削除</a></li>
                                                  </ul>
                                             </div>
                                        </div>
                                        ...
                                        <div class="d-flex flex-wrap mx-1 mb-1">
                                             @foreach ($todo->tags()->orderBy('id', 'asc')->get() as $tag)
                                                  <span class="bage bg-secondary mt-2 me-2 fw-light">{{ $tag->name }}</span>
                                             @endforeach
                                        </div>
                                   </div>
                              </div>
